...
def train_and_plot_som(df, som_shape=(6, 6), sigma=1.0, learning_rate=0.5, iterations=1000, plot=True, random_state=42):
    """
...
def train_and_plot_som_per_variable(df, som_shape=(6, 6), sigma=1.0, learning_rate=0.5, iterations=1000, random_state=42):
    """
